...
func mainMenu() {
	...
	for {
		...
		fmt.Println(strings.Repeat("=", 14), "Toko Laundry Enigma", strings.Repeat("=", 15))
        fmt.Println(strings.Repeat("=", 50))
		fmt.Println(strings.Repeat("=", 20), "Main Menu", strings.Repeat("=", 19))
...
func customerMenu() {
	var choice int
	fmt.Println(strings.Repeat("=", 50))
	fmt.Println(strings.Repeat("=", 14), "Customer Menu", strings.Repeat("=", 21))
...
func serviceMenu() {
	var choice int
	fmt.Println(strings.Repeat("=", 50))
	fmt.Println(strings.Repeat("=", 14), "Service Menu", strings.Repeat("=", 22))
...
func orderMenu() {
	var choice int
    fmt.Println(strings.Repeat("=", 50))
    fmt.Println(strings.Repeat("=", 14), "Order Menu", strings.Repeat("=", 24))
